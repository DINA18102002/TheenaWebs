...
<head>
    ...
    <title>TheenBuild - Reports</title>
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select" multiple>
                                    <option selected>admin@theenbuild.com</option>
                                    <option>finance@theenbuild.com</option>
                                    <option>projects@theenbuild.com</option>
                                    <option>hr@theenbuild.com</option>
                                </select>
